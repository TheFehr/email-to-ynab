    ...
    class ContentParser
      class << self
        def parse_bodies(bodies)
          mail_entries = []
          accounts = Helpers::Config::Helper.new.accounts
        ...
        def find_payee_id(memo)
          transfer_ids = Helpers::Config::Helper.new.transfer_ids.dup
        ...
        def find_payee_name(memo)
          regexps = Helpers::Config::Helper.new.payee_name_regexps.dup
        ...
        def match_mail_regexps(content)
          email_parts_regexps = Helpers::Config::Helper.new.email_parts_regexps
